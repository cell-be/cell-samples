...
namespace Nes
{
	void queword::Multiply(queword multiplier)
	{
		queword multiplicand(*this);
		lo = 0;
		hi = 0;
	...
	void queword::Divide(queword& dividend,const queword divisor,const bool mod)
	{
